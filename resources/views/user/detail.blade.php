                ...
                <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel" class="form-control @error('phone_number') is-invalid @enderror"
                                   ...
                                   placeholder="+62 812-3456-7890" disabled>
                            @error('phone_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control @error('password') is-invalid @enderror"
                                       id="password" name="password" placeholder="Enter password" disabled>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" disabled>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror"
                                  ...
                                  placeholder="Enter full address" disabled>{{ old('address', $user->address) }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
